          ...
          <ul class="flex h-full flex-col gap-2 overflow-y-auto pr-1">
            <For each={visibleSessions()}>
              {(session) => {
                ...
                return (
                  <div
                    class={`group relative flex w-full items-center justify-between rounded-xl border px-3 py-2 text-left transition ${
                      isActive
                  ...
                  >
                    ...
                    <div class="absolute right-1 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100">
                      <Dropdown
                        trigger={(triggerProps) => (
                          <button
                            {...triggerProps}
                            type="button"
                            class="rounded-md p-1 text-slate-400 hover:bg-slate-700 hover:text-slate-100"
                          >
